...
What is OpenVAS?::An open-source vulnerability scanner (now part of Greenbone Vulnerability Management) that tests hosts and services against a continuously updated feed of network vulnerability tests.

What commercial scanner is OpenVAS a free alternative to?::Nessus.

What does OpenVAS detect?::Missing patches, misconfigurations, and known CVEs.
