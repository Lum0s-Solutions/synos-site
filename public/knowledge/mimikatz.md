...
What is Mimikatz used for?::A post-exploitation tool that extracts plaintext passwords, hashes, PINs, and Kerberos tickets from Windows memory, primarily the LSASS process.
