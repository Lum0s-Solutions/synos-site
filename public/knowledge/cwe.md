...
What is CWE (Common Weakness Enumeration)?::A community-maintained, categorized list of common software/hardware weakness types that represent the root causes of vulnerabilities.

Give two examples of CWE entries.::CWE-79 (Cross-site Scripting) and CWE-89 (SQL Injection).

How does CWE differ from CVE?::CWE catalogs weakness classes (root causes); CVE catalogs specific vulnerability instances.

What well-known resource does CWE underpin?::The CWE Top 25.
