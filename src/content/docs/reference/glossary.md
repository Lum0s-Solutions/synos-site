...
**Last Light** — The 1.0 release candidate (code-complete; public ISOs pending). **v111.0.0 (current).** Completes the v101→v111 "Rust Everything" software campaign. ALFRED v6.0, GRIMOIRE 1.0 (241 labs), 227 crates, post-quantum by default.
